...
import 'package:github_repo_app/ui/all_repo/widget/all_repo_widget.dart';
import 'package:github_repo_app/ui/common/custom_widget.dart';
import 'package:github_repo_app/ui/common/loader.dart';
...
class _AllRepoScreenState extends State<AllRepoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(
          context: context, title: AppTextData.flutterRepository, isHome: true),
